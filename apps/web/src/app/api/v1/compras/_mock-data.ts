...
export interface PedidoCompraMock {
  id: string;
  numero: string;
  fornecedorId: string;
  fornecedor: string;
...
declare global {
  ...
  var __comprasMock: PedidoCompraMock[] | undefined;
  // eslint-disable-next-line no-var
  var __comprasSeq: number | undefined;
  // eslint-disable-next-line no-var
  var __contasAPagarMock: Array<{
    id: string; compraId: string; fornecedorId: string; fornecedor: string;
    valor: number; vencimento: string; status: 'PENDENTE' | 'PAGO' | 'VENCIDO';
    criadoEm: string;
  }> | undefined;
}
...
const _df = (diasFuturos: number) => new Date(Date.now() + diasFuturos * 86400000).toISOString();

// ─── Initial data ─────────────────────────────────────────────────────────────

const INITIAL_COMPRAS: PedidoCompraMock[] = [
  {
    id: 'cmp-001', numero: '000001', fornecedorId: 'f-001', fornecedor: 'TechDist',
    status: 'RECEBIDO',
    itens: [
    ...
    valorProdutos: 40100, valorFrete: 450, valorImpostos: 5274.25, valorTotal: 8500,
    dataEmissao: _d(25), dataRecebimento: _d(20),
    nfeNumero: '001234', nfeSerie: '1', nfeChave: '35240312345678000190550010012340001234567890',
    condicaoPagamento: '30/60/90 dias', formaPagamento: 'Boleto Bancário',
    criadoEm: _d(25), atualizadoEm: _d(20),
  },
  {
    id: 'cmp-002', numero: '000002', fornecedorId: 'f-002', fornecedor: 'ElecBrasil',
    status: 'RECEBIDO',
    itens: [
    ...
    valorProdutos: 15150, valorFrete: 250, valorImpostos: 2370.88, valorTotal: 15200,
    dataEmissao: _d(18), dataRecebimento: _d(14),
    nfeNumero: '005678', nfeSerie: '1', nfeChave: '33240398765432000110550010056780005678901234',
    condicaoPagamento: '30 dias', formaPagamento: 'PIX',
    criadoEm: _d(18), atualizadoEm: _d(14),
  },
  {
    id: 'cmp-003', numero: '000003', fornecedorId: 'f-003', fornecedor: 'Moda Fashion',
    ...
    valorProdutos: 12510, valorFrete: 380, valorImpostos: 1957.82, valorTotal: 4300,
    dataEmissao: _d(5), dataPrevistaEntrega: _df(5),
    condicaoPagamento: '28 dias', formaPagamento: 'Boleto Bancário',
    criadoEm: _d(5), atualizadoEm: _d(5),
  },
  {
    id: 'cmp-004', numero: '000004', fornecedorId: 'f-004', fornecedor: 'Calçados Premium',
    status: 'ENVIADO',
    itens: [
    ...
    valorProdutos: 7720, valorFrete: 200, valorImpostos: 1207.18, valorTotal: 6700,
    dataEmissao: _d(3), dataPrevistaEntrega: _df(10),
    condicaoPagamento: '30 dias', formaPagamento: 'Boleto Bancário',
    criadoEm: _d(3), atualizadoEm: _d(3),
  },
  {
    id: 'cmp-005', numero: '000005', fornecedorId: 'f-001', fornecedor: 'TechDist',
    status: 'RECEBIDO',
    itens: [
    ...
    valorProdutos: 97500, valorFrete: 980, valorImpostos: 15258.75, valorTotal: 22000,
    dataEmissao: _d(10), dataRecebimento: _d(7),
    nfeNumero: '009012', nfeSerie: '1', nfeChave: '35240312345678000190550010090120009012345678',
    condicaoPagamento: '30/60/90 dias', formaPagamento: 'Boleto Bancário',
    criadoEm: _d(10), atualizadoEm: _d(7),
  },
  {
    id: 'cmp-006', numero: '000006', fornecedorId: 'f-002', fornecedor: 'ElecBrasil',
    status: 'RASCUNHO',
    itens: [
    ...
    valorProdutos: 18050, valorFrete: 300, valorImpostos: 2824.83, valorTotal: 3400,
    dataEmissao: _d(1),
    condicaoPagamento: '30 dias', formaPagamento: 'PIX',
    criadoEm: _d(1), atualizadoEm: _d(1),
  },
  {
    id: 'cmp-007', numero: '000007', fornecedorId: 'f-005', fornecedor: 'InfoParts',
    status: 'CANCELADO',
    itens: [
    ...
    valorProdutos: 2700, valorFrete: 100, valorImpostos: 422.55, valorTotal: 1200,
    dataEmissao: _d(30),
    condicaoPagamento: '15 dias', formaPagamento: 'PIX',
    observacoes: 'Cancelado por falta de estoque no fornecedor.',
    criadoEm: _d(30), atualizadoEm: _d(28),
  },
  {
    id: 'cmp-008', numero: '000008', fornecedorId: 'f-003', fornecedor: 'Moda Fashion',
    status: 'RECEBIDO',
    itens: [
    ...
    valorProdutos: 20270, valorFrete: 520, valorImpostos: 3172.26, valorTotal: 9800,
    dataEmissao: _d(15), dataRecebimento: _d(12),
    nfeNumero: '003456', nfeSerie: '1', nfeChave: '42240345678901000123550010034560003456789012',
    condicaoPagamento: '28 dias', formaPagamento: 'Boleto Bancário',
    criadoEm: _d(15), atualizadoEm: _d(12),
  },
];

// ─── Persistência via globalThis ──────────────────────────────────────────────

if (!globalThis.__comprasSeq) globalThis.__comprasSeq = 9;
if (!globalThis.__comprasMock) globalThis.__comprasMock = INITIAL_COMPRAS;
if (!globalThis.__contasAPagarMock) globalThis.__contasAPagarMock = [];

export const COMPRAS_MOCK: PedidoCompraMock[] = globalThis.__comprasMock;

export function nextNumeroCompra(): string {
  const seq = (globalThis.__comprasSeq ?? 8) + 1;
  globalThis.__comprasSeq = seq;
