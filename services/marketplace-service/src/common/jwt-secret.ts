 ...
 *
 * NUNCA usar o antigo fallback silencioso 'dev-secret-somente-desenvolvimento'
 * como retorno incondicional dentro do código de verificação de token.
 */
  ...
  if (emProducao) {
    throw new Error(
      'JWT_SECRET não definido. É obrigatório em produção — ' +
        'defina a variável de ambiente antes de iniciar o marketplace-service.',
    )
  }
