  ...
  const movimentacoes = [
    {
      ...
      observacao: 'Compra fornecedor - NF 12345',
    },
    {
      tenantId: TENANT_ID,
      produtoId: PROD_001,
      ...
      observacao: 'Vendas do mês - Pedidos #101 a #145',
    },
    {
      tenantId: TENANT_ID,
      produtoId: PROD_001,
      ...
      quantidade: 20,
      motivo: 'TRANSFERENCIA_DEPOSITO' as const,
      observacao: 'Transferência para loja física',
    },
    {
      tenantId: TENANT_ID,
      produtoId: PROD_010,
      ...
      observacao: 'Ajuste de inventário - itens danificados',
    },
  ];
